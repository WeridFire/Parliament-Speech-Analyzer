...
The patterns are designed to be time-agnostic: we capture the role as stated in the
stenographic report, not by mapping names to positions.

This ensures that when ministers change, speeches are still correctly attributed
to whoever held that role at that time.
"""
